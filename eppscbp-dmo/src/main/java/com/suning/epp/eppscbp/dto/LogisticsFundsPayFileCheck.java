...
public class LogisticsFundsPayFileCheck {
    /**
     * 明细业务单号
     */
     ...
     * 发货方式
     *//*
        * @Option(value=EnumCodes.TRANS_TYPE, message = "未知的发货方式", groups = { Default.class }) private String transType;
        */
    /**
     * 留学者计划境外居留时间
     */
    @Option(value = EnumCodes.FREIGHT_TYPE, message = "未知的货运类型", groups = { Default.class })
    ...
    public String toString() {
        return "CtUaFileCheck [tradeNo=" + tradeNo + ", orderType=" + orderType + ", createTime=" + createTime + ", payTime=" + payTime +
                ", totalAmt=" + totalAmt + ", customType=" + customType + ", personName=" + FrontHideBitRule.nameHideForCN(personName) + ", personId=" + BackHideBitRule.idCardHide(personId) +
                ", personIdType=" + personIdType + ", orgName=" + orgName + ", orgType=" + orgType + ", orgId=" + orgId + ", freightType=" + freightType + ", productName=" + productName +
                ", productNum=" + productNum + ",logistcsCompName=" + logistcsCompName + ", logistcsWoNo=" + logistcsWoNo + ",merchandiseType=" + merchandiseType + "]";
    }
}
