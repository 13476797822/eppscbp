 ...
 * FileName: GoodsPayServiceImpl.java
 * Author:   17061545
 * Date:     2018年3月20日 上午11:56:16
...
public class GoodsPayServiceImpl implements GoodsPayService {
    ...
    /*
     * (non-Javadoc)
     * @see com.suning.epp.eppscbp.service.GoodsPayService#submiteSettleOrder(com.suning.epp.eppscbp.dto.
    ...
    public ApiResDto<OrderlAcquireResponseDto> submiteSettleOrder(OrderApplyAcquireDto orderApplyAcquireDto) {
        LOGGER.info("货物贸易单笔付汇提交:{}", orderApplyAcquireDto.toString());
        ...
        LOGGER.info("货物贸易单笔付汇提交参数:{}", orderApplyAcquireDto.toString());
