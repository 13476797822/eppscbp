 ...
 * @since [产品/模块版本] （可选）
 */ 
public class StudyExAndPayServiceImplTest {
    @InjectMocks
    StudyExAndPayServiceImpl studyExAndPayServiceImpl;
    ...
    public void submiteSettleOrder() {
        ...
        studyExAndPayServiceImpl.submiteSettleOrder(orderApplyAcquireDto);    
        Mockito.when(unifiedReceiptService.submiteSettleOrder(Mockito.any(OrderApplyAcquireDto.class))).thenReturn(apiResDto);
    ...
    public void confirmPayment() {
        ...
        studyExAndPayServiceImpl.confirmPayment(orderOperationDto);  
    } 
    ...
    public void queryBalance() {
        ...
        studyExAndPayServiceImpl.queryBalance("1","2","3");  
    } 
    @Test
    public void eppSecretKeyRsfServer() {
        ...
        studyExAndPayServiceImpl.eppSecretKeyRsfServer();  
    } 
    ...
    public void validatePaymentPassword() {
        ...
        studyExAndPayServiceImpl.validatePaymentPassword("1","2");  
    } 
}
