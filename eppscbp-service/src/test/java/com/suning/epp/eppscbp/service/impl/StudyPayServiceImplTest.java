 ...
 * @since [产品/模块版本] （可选）
 */ 
public class StudyPayServiceImplTest {
    @InjectMocks
    StudyPayServiceImpl studyPayServiceImpl;
    ...
    public void submiteSettleOrder() {
        ...
        studyPayServiceImpl.submiteSettleOrder(orderApplyAcquireDto);    
        Mockito.when(unifiedReceiptService.submiteSettleOrder(Mockito.any(OrderApplyAcquireDto.class))).thenReturn(apiResDto);
    ...
    public void confirmPayment() {
        ...
        studyPayServiceImpl.confirmPayment(orderOperationDto);  
    } 
    ...
    public void queryBalance() {
        ...
        studyPayServiceImpl.queryBalance("1","2","3");  
    } 
    @Test
    public void eppSecretKeyRsfServer() {
        ...
        studyPayServiceImpl.eppSecretKeyRsfServer();  
    } 
    ...
    public void validatePaymentPassword() {
        ...
        studyPayServiceImpl.validatePaymentPassword("1","2");  
    } 
}
