 ...
 * @since [产品/模块版本] （可选）
 */ 
public class GoodsExAndPayServiceImplTest {
    @InjectMocks
    GoodsExAndPayServiceImpl goodsExAndPayServiceImpl;
    ...
    public void submiteSettleOrder() {
        ...
        goodsExAndPayServiceImpl.submiteSettleOrder(orderApplyAcquireDto);    
        Mockito.when(unifiedReceiptService.submiteSettleOrder(Mockito.any(OrderApplyAcquireDto.class))).thenReturn(apiResDto);
    ...
    public void confirmPayment() {
        ...
        goodsExAndPayServiceImpl.confirmPayment(orderOperationDto);  
    } 
    ...
    public void queryBalance() {
        ...
        goodsExAndPayServiceImpl.queryBalance("1","2","3");  
    } 
    @Test
    public void eppSecretKeyRsfServer() {
        ...
        goodsExAndPayServiceImpl.eppSecretKeyRsfServer();  
    } 
    ...
    public void validatePaymentPassword() {
        ...
        goodsExAndPayServiceImpl.validatePaymentPassword("1","2");  
    } 
}
