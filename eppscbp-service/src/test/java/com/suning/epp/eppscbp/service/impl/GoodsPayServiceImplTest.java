 ...
 * @since [产品/模块版本] （可选）
 */ 
public class GoodsPayServiceImplTest {
    @InjectMocks
    GoodsPayServiceImpl goodsPayServiceImpl;
    ...
    public void submiteSettleOrder() {
        ...
        goodsPayServiceImpl.submiteSettleOrder(orderApplyAcquireDto);    
        Mockito.when(unifiedReceiptService.submiteSettleOrder(Mockito.any(OrderApplyAcquireDto.class))).thenReturn(apiResDto);
    ...
    public void confirmPayment() {
        ...
        goodsPayServiceImpl.confirmPayment(orderOperationDto);  
    } 
    ...
    public void queryBalance() {
        ...
        goodsPayServiceImpl.queryBalance("1","2","3");  
    } 
    @Test
    public void eppSecretKeyRsfServer() {
        ...
        goodsPayServiceImpl.eppSecretKeyRsfServer();  
    } 
    ...
    public void validatePaymentPassword() {
        ...
        goodsPayServiceImpl.validatePaymentPassword("1","2");  
    } 
}
