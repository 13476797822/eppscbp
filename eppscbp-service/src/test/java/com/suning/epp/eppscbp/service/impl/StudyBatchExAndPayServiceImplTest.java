 ...
 * @since [产品/模块版本] （可选）
 */ 
public class StudyBatchExAndPayServiceImplTest {
    @InjectMocks
    StudyBatchExAndPayServiceImpl batchExAndPayServiceImpl;
    ...
    public void submiteSettleOrder() {
        ...
        Mockito.when(unifiedReceiptService.batchSubmiteOrder(Mockito.any(OrderApplyAcquireDto.class))).thenReturn(apiResDto);
        OrderApplyAcquireDto orderApplyAcquireDto =new OrderApplyAcquireDto();
        orderApplyAcquireDto.setAmtType("01");
        batchExAndPayServiceImpl.submiteSettleOrder(orderApplyAcquireDto);    
    }  
    ...
    public void confirmPayment() {
        ...
        batchExAndPayServiceImpl.confirmPayment(orderOperationDto);  
    } 
    ...
    public void queryBalance() {
        ...
        batchExAndPayServiceImpl.queryBalance("1","2","3");  
    } 
    @Test
    public void eppSecretKeyRsfServer() {
        ...
        batchExAndPayServiceImpl.eppSecretKeyRsfServer();  
    } 
    ...
    public void validatePaymentPassword() {
        ...
        batchExAndPayServiceImpl.validatePaymentPassword("1","2");  
    } 
}
