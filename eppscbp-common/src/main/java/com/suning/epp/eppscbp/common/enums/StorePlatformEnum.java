...
public enum StorePlatformEnum {
    ...
    SRORE_PLATFORM_AMAZON("1", "亚马逊"),

    SRORE_PLATFORM_EBAY("2", "EBay");

    private String code;

    private String description;

    private StorePlatformEnum(String code, String description) {
        this.code = code;
    ...
    public static String getDescriptionFromCode(String code) {
        ...
        for (StorePlatformEnum type : StorePlatformEnum.values()) {
