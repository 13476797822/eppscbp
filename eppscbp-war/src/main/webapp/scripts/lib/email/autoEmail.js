...
jQuery.AutoComplete = function(selector){
    ...
    strHtml.push('      <li hz="@yeah.net"></li>');
    strHtml.push('      <li hz="@tom.com"></li>');
    strHtml.push('      <li hz="@139.com"></li>');
    strHtml.push('      <li hz="@189.com"></li>');
    strHtml.push('      <li hz="@hotmail.com"></li>');
    strHtml.push('      <li hz="@outlook.com"></li>');
    strHtml.push('      <li hz="@foxmail.com"></li>');
    strHtml.push('      <li hz="@aliyun.com"></li>');
    strHtml.push('  </ul>');
    strHtml.push('</div>');
