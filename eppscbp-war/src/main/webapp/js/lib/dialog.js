...
(function($, window, document, undefined) {
    ...
    var HTML = '<div class="ui-dialog-wrap"><div class="ui-dialog-outer"><div class="ui-dialog-inner"><div class="ui-dialog-cont"></div></div></div></div>',
        HEAD = '<div class="ui-dialog-head"><div class="ui-dialog-title"></div><a href="javascript:;" class="ui-dialog-close">&times;</a></div>',
    ...
    Dialog.prototype = {
        ...
        head: function() {
            ...
            if ((typeof close === 'boolean' && !close) || (close === 'true')) {
                ...
                this.$head.find('.ui-dialog-close').outerHTML = '';
            }
