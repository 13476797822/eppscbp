(function($) {
                ...
                setEvent: function(options) {
                    ...
                    g.dom["cityboxbtn"].click(function(event) {
                        ...
                        if(options.isAvailable==0){
                            ...
                            g.dom["citybox"].show().css("top", g.inputHeight +5+ "px");
    ...
    $.fn.SnAddress.defaults = {
        url: "http://fbdqs.cnsuning.com/fbdqs/public/queryResAddress.htm",
        innerHtml: ' <a href="javascript:void(0);"  class="cityboxbtn" ></a><i class="dropdown"></i><input type="text" class="det-address">' + '<div class="citybox">' + '<div class="chooseArea">' + "</div>" + '<div  class="arriveBox">' + '<div class="cityshow"></div>' + "</div>" + '<div class="closeSelector"></div>' + "</div>",
        level: 1,
        columns: [{
            state: "prov",
            text: "请选择省",
