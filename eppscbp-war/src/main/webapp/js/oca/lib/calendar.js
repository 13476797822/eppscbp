(function(root, factory) {
	...
	var calendar = function(options) {
		var def = {
			...
			startTime: [], //起始时间
			selectRange: { min: 1971, max: 2050 }, // 时间间隔，默认是 1971-2050
			callback: function() {
				//回调函数
			}
		};
		...
		var calendarfn = {
			...
			_creade: function() {
				...
				var aTmp = [],
					aTmpt = [],
					close = '<span class="cal-close">close</span>',
					htmlp = '<span class="cal-prev">prev</span>',
					htmln = '<span class="cal-next">next</span>';
			...
			linkOn: function() {
				...
				links.each(function(a) {
					$(this).click(function() {
						...
						if (showbox == null) {
							input[0].tagName.toUpperCase() === "INPUT"
								? input.val($.trim(
										$(this)[0]["data-date"] +
											" " +
											(isWeek
