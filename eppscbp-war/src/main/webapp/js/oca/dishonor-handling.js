    ...
    var main = {
        ...
        acceptFun: function () {
            $('.appeal').live('click', function () {
                ...
                var rejectComment = $(this).parents('.operation-item').attr('data-rejectComment');
                ...
                var d = $.dialog({
                    ...
                    content: template('dialog-appeal', {
                        content: {
                            ...
                            rejectCommentStr: rejectComment,
                            rejectOrderNo: rejectOrderNo,rejectAmtStr:rejectAmt,
        ...
        queryLoanList: function() {
            ...
            url: sysconfig.ctx + "/oca/ocaRejectHandingOrderController/queryRejectOrderHanding.htm",
