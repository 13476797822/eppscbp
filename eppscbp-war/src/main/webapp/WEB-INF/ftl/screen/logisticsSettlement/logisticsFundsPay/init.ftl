<meta charset="UTF-8">
            ...
            <form id="fillCross" method="post" name="f0">
               <ul class="input-list" id="accountContent">
                    ...
                    <li class="input-item clearfix">
                        ...
                        <input type="text" name="payAmt" class="input" id="applyMoney" <#if criteria.payAmt != 0> value="${criteria.payAmt}" </#if>  placeholder="申请金额"><i id="curName">${criteria.curName}</i>
                    ...
                    <li class="input-item clearfix">
                       <span class="input-title"><i class="red-warn">*</i>国际物流进出境运输：</span>
                       <div class="jr-select">
                           <i class="select-input-arrow-icon arrow-icon-closed"></i>
                           <input type="text" name="logisticsType" class="select-input empty" readonly id="logisticsType" key="">
                           <ul class="select-box">
                                <#if logisticsType??>
                    ...
                    <input type="text" name="requestUrl" value="/logisticsSettlement/logisticsFundsPay/fileSubmit.htm" class="input file-path" style="position:absolute;z-index:-1;font-size:0;border:0;left:-1000%;">
                   	<li class="input-item upload-files"> 
                        ...
                        <div class="file-operation">
                            ...
                            <form id="uploadForm" enctype="multipart/form-data">  
                            	<a class="up" href="javascript:;">选择文件<input type="file" id="file-btn" name="file" accept="application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"></a>
                            </form> 
    ...
    <script type="text/javascript">
		...
		function download(){
			window.onbeforeunload=function(){
 			...
 			window.location.href=sysconfig.ctx+"/template/file/logisticsFundsPay_apply_template.xlsx";
 			return false; 
    	}
    	//提交订单
		function submitOrder(){
    	    ...
    	    formObj.attr("action", sysconfig.ctx+"/logisticsSettlement/logisticsFundsPay/applySubmit.htm");
    	    formObj.submit(); 
    ...
    <script type="text/javascript">    	
		window.onload = function(){
			var merchantArray = JSON.parse('${Session["merchantInfoListRMB"]}');
			if(merchantArray[0] == ",,"){
				merchantArray[0][0] = "0";
