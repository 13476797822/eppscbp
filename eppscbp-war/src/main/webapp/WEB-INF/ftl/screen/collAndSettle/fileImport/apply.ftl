<meta charset="UTF-8">
	...
	<div class="batch-payment">
        ...
        <form  id="applyForm" method="post" name="applyForm">
            <p class="title">收结汇
                <font>将外汇自动结汇成人民币至易付宝账户</font>
            </p>
            <ul class="valid-form">
                <li class="clearfix" id="platformNameDiv">
                    <div class="label-filed"><em>*</em>平台名称 ：</div> 
                ...
                <li class="clearfix" id="referenceRateDiv">
                    <div class="label-filed">参考汇率：</div>
                    <div class="input-item" name="referenceRateFake" id="referenceRateFake"></div>
					<input type="text" name="referenceRate" id="referenceRate" style="position:absolute;z-index:-1;font-size:0;border:0;left:-1000%;">					
                </li>
                <li class="clearfix">
                ...
                <li class="clearfix">
                    ...
                    <div class="input-item jr-select">
                        ...
                        <ul class="select-box">
                            <li class="select-item">
                                <a class="sel-val" href="javascript:void(0);" key="1" value="货物贸易">
                                   	 货物贸易
                                </a>
                            </li>                            
                        </ul>
                ...
                <li class="clearfix">
                    ...
                    <div class="input-item clearfix">
                        ...
                        <a href="${ctx}/template/file/coll_sett_apply_template.xlsx" class="download fl">下载模板</a>
                        <p class="tips"></p>
    ...
    <script type="text/javascript" data-main="${ctx}/scripts/eppscbp/sjh-apply-main" src="${ctx}/scripts/lib/require/require.min.js"></script>
