    ...
    <script type="text/javascript">   	
    	...
    	function submitPayment(){
        	...
        	$.ajax({
            	type: "POST",
            	data:{"cur":cur},
            	url:sysconfig.ctx+"/goodsTrade/goodsPay/submitPayment.htm",
            	dataType: "JSON",
    	...
    	function refreshRate(){
    	    ...
    	    formObj.attr("action", sysconfig.ctx+"/goodsTrade/goodsPay/refreshRate.htm");
    	    formObj.submit();
    	}
    	//提交支付按钮事件
    	function confirmPayment(){
	        ...
	        $.ajax({
	            ...
	            url:sysconfig.ctx+"/goodsTrade/goodsPay/confirmPayment.htm",
	            dataType: "JSON",
	            success: function(data) {
