<meta charset="UTF-8">
    ...
    <div class="batch-payment">
        ...
        <div class="content">
            ...
            <form id="fillCross" method="post" name="f0">
	            ...
	            <div class="tip-text">提示：请在交易订单查询页面点击去支付按钮</div>
    ...
    <script type="text/javascript">	
    	...
    	function submitPayment(){
        	...
        	$.ajax({
            	type: "POST",
            	url:sysconfig.ctx+"/goodsTrade/goodsExAndPay/submitPayment.htm",
            	dataType: "JSON",
    	...
    	function refreshRate(){
    	    ...
    	    formObj.attr("action", sysconfig.ctx+"/goodsTrade/goodsExAndPay/refreshRate.htm");
    	    formObj.submit();
    	}
    	//提交支付按钮事件
    	function confirmPayment(){
	        ...
	        $.ajax({
	            ...
	            url:sysconfig.ctx+"/goodsTrade/goodsExAndPay/confirmPayment.htm",
	            dataType: "JSON",
	            success: function(data) {
	            	if(data.success == "s"||data.success == "pf"||data.success == "o"){
	            		
	            		var temp = document.createElement("form");
  						temp.action = sysconfig.ctx+"/goodsTrade/goodsTradeInit/payResult.htm";
  						temp.method = "post";
