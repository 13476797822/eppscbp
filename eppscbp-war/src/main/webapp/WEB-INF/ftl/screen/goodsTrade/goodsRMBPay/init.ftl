<meta charset="UTF-8">
	...
	<div class="batch-payment">
        ...
        <div class="content">
            <!-- 单笔购付汇填写页面 -->
            <h3 class="content-title">单笔跨境人民币结算</h3>
            <!-- 填写购付汇信息 -->
            ...
            <form id="fillCross" method="post" name="f0">
               <ul class="input-list" id="accountContent">
                    ...
                    <input type="text" name="requestUrl" value="/goodsTrade/goodsRMBPay/fileSubmit.htm" class="input file-path" style="position:absolute;z-index:-1;font-size:0;border:0;left:-1000%;">
    ...
    <script type="text/javascript">
		...
		function submitOrder(){
    	    ...
    	    formObj.attr("action", sysconfig.ctx+"/goodsTrade/goodsRMBPay/applySubmit.htm");
    	    formObj.submit(); 
             	...
             	success: function(data) {
            	 	...
            	 	if(data.success == "s"){
            	 	    ...
            	 	    if(data.responseMsg == undefined) {
            	 	        $("#receiveName").parent().append("<p class='red-warn'>页面停留太久,请刷新页面后重试</p>");   
            	 	    } else {
