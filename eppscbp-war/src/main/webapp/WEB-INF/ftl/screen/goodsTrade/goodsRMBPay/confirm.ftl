<meta charset="UTF-8">
    ...
    <div class="batch-payment">
        ...
        <div class="content">
            <!-- 单笔购付汇支付页面 -->
            <h3 class="content-title">单笔人民币结算</h3>
            <!-- 填写购付汇信息 -->
    ...
    <script type="text/javascript">	
    	...
    	function submitPayment(){
        	...
        	$.ajax({
            	type: "POST",
            	url:sysconfig.ctx+"/goodsTrade/goodsRMBPay/submitPayment.htm",
            	dataType: "JSON",
    	...
    	function confirmPayment(){
	        ...
	        $.ajax({
	            ...
	            url:sysconfig.ctx+"/goodsTrade/goodsRMBPay/confirmPayment.htm",
	            dataType: "JSON",
	            success: function(data) {
