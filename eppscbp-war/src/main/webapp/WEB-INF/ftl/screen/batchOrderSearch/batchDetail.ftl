 <meta charset="UTF-8">
    ...
    <div class="batch-payment">
        ...
        <div class="content">
            ...
            <a href="${ctx}/batchQuery/batchOrderRemitQuery/init.htm" class="back-top-up"><i class="back-icon"></i>返回上级</a>
            ...
            <div class="order-detail-box clearfix">
                    ...
                    <div class="step ">
                        ...
                        <ul class="clearfix">
                            <li <#if result.status=='11'||result.status=='20'||result.status=='21'> class="hover" </#if> >
                                ...
                                <#if result.status=='11'||result.status=='20'||result.status=='21'>                            
                ...
                <div class="list">
                    <ul class="clearfix last">
                        ...
                        <li>
                            <span class="list-item-title">跨境付汇款子单号：</span>
                            <span class="list-item-content">${result.subBusinessNo}</span>
                        </li>
                        <li>
                        ...
                        <li class="long-text">
                            ...
                            <span class="list-item-content long">${result.fullAmtTypeName}</span>
                        </li>
                        <li class="long-text">
                ...
                <div class="list">
                    <ul class="clearfix last">
                        <li>
                            <span class="list-item-title">还原客户名称：</span>
                            <span class="list-item-content">${result.personalName}</span>
                        </li>
                        <li>
                            <span class="list-item-title">还原客户证件号码：</span>
                            <span class="list-item-content">${result.personalId}</span>
                        </li>
                        <li>
