<meta charset="UTF-8">
        ...
        <div class="content">
            ...
            <form id="fillCross" method="post" name="f0">
               <ul class="input-list" id="accountContent">
                    ...
                    <input type="text" name="requestUrl" value="/overseasPay/studyExAndPay/fileSubmit.htm" class="input file-path" style="position:absolute;z-index:-1;font-size:0;border:0;left:-1000%;">
    ...
    <script type="text/javascript">
		...
		function submitOrder(){
    	    ...
    	    formObj.attr("action", sysconfig.ctx+"/overseasPay/studyExAndPay/applySubmit.htm");
    	    formObj.submit(); 
    	...
    	function queryMerchantMeg(){
			...
			$("#receiveName").parent().find(".red-warn").remove();
			$("#receiveName").parent().find(".tip-red").remove();
